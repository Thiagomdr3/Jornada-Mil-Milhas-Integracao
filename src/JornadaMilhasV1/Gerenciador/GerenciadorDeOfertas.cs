...
public class GerenciadorDeOfertas
{
    ...
    //private readonly OfertaViagemDAL _ofertaViagemDal;

    //public GerenciadorDeOfertas(OfertaViagemDAL ofertaViagemDal)
    //{
    //    _ofertaViagemDal = ofertaViagemDal;
    //}
    ...
    public OfertaViagem? ExibirMaiorDesconto() =>
        ofertaViagem.OrderBy(o => o.Preco).FirstOrDefault();
